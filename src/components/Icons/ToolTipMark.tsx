...
export default function ToolTipMark({ width, height, ...rest }: { width: number; height: number; [x: string]: any }) {
  return (
    <svg width={width} height={height} viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path d="M6.54545 5.45455V8.72727H5.45455V5.45455H6.54545Z" fill="#8B8E95" />
      <path d="M6.55091 3.27273H5.45455V4.36364H6.55091V3.27273Z" fill="#8B8E95" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
