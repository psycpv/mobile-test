...
import { useActiveAccountAddress, useBalanceHistory, useGetBalanceHistoryCallback } from 'state/user/hooks'
...
export default function BalanceHistory() {
  ...
  useEffect(() => {
    if (!isLoaded) {
      if (balanceHistory && Object.values(balanceHistory).length) setIsLoaded(true)
    }
