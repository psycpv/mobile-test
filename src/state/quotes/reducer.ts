...
import { QuoteOrder, QuotesState } from './types'
...
export const initialState: QuotesState = {
  ...
  historyOrderColumn: 'timeStamp',
  historyOrder: QuoteOrder.DESCENDING,
}
...
export default createReducer(initialState, (builder) =>
  builder
    ...
    .addCase(setHistoryOrder, (state, { payload: { chainId, column, order } }) => {
      state.history[chainId] = []
      state.hasMoreHistory = false
      state.historyOrderColumn = column
      state.historyOrder = order
    })

    .addCase(setHistoryRangeTime, (state, { payload: { chainId, startTime, endTime } }) => {
      state.history[chainId] = []
      state.hasMoreHistory = false
