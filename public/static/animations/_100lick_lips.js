...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#E89FED").s().p("AmcImQiSgJg7iBIgQgSQgUgbgPgqIAAAAQgqh1AKh3QAIhUApiBQAqiBBqhgQBUhNCCg7QBKgiBcgRIBZgMQBcgHBQAOQCMAXBmA1QCABCBJBzQBJBxAcBQQAmBnghEtQgLBxnYBCQmgA7iiAAIgmgBg");
	this.shape.setTransform(-0.495,-1.6915);
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#05104D").ss(21,1,1).p("AsVI9IA/CEQBCgGCFALQCEALBzgVQDiAXB/goQDigfBzgfQBzgfCNgKICshPIAdiRQAkjsg5jbQgui1hfh/Qh2igjchQQjEhHjoAFQg7ACgaAEQgeADgyAOQjSA2idB1QixCDhCC2Qg2CTACC5QAEDjBbDcg");
	this.shape_1.setTransform(0.0338,0.4096);
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#843D7E").s().p("AoPLGQiFgLhCAGIg/iEQhbjcgEjjQgCi5A2iTQBCi2CxiDQCdh1DSg2QAygOAegDQAagEA7gCQDogFDEBHQDcBQB2CgQBfB/AuC1QA5DbgkDsIgdCRIisBPQiNAKhzAfQhzAfjiAfQh/AojigXQhLAOhTAAQgrAAgugEg");
	this.shape_2.setTransform(0.0338,0.4096);
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));
	this._renderFirstFrame();
}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-98.9,-81.5,197.9,163.8);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(233.198,175.1135,1,1.0945);
	this.shape_1 = new cjs.Shape();
	...
	this.shape_1.setTransform(233.1407,226.6949,1,1.0945);
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#0163AF").s().p("AgqgfQBjAZgQAmQgoghgrgeg");
	this.shape_2.setTransform(438.3419,212.5705,1,1.0945);
	this.shape_3 = new cjs.Shape();
	...
	this.shape_3.setTransform(244.7079,257.7435,1,1.0945);
	...
	this.shape_4.setTransform(200.0161,114.2039,1,1.0945);
	...
	this.shape_5.setTransform(-233.1979,175.129,1,1.0945);
	...
	this.shape_6.setTransform(-233.1123,226.7202,1,1.0945);
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#0163AF").s().p("AArgfQguAfglAgQgPgmBigZg");
	this.shape_7.setTransform(-438.3299,212.5952,1,1.0945);
	...
	this.shape_8.setTransform(-244.6986,257.7613,1,1.0945);
	...
	this.shape_9.setTransform(-200.0161,114.2176,1,1.0945);
...
p.nominalBounds = new cjs.Rectangle(-494.9,-328.8,989.9,679);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(235.75,1064.6,1,1,7.7275,0,0,-0.1,0);
	var maskedShapeInstanceList = [this.instance_1];
	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask;
	}
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regX:0,regY:0.4,rotation:8.0581,x:263,y:1016.35},0).wait(1).to({rotation:8.3885,x:299.9,y:988.25},0).wait(1).to({rotation:8.7189,x:355.35,y:967.45},0).wait(1).to({rotation:9.0493,x:406.4,y:951},0).wait(1).to({rotation:9.3798,x:450.6,y:938.2},0).wait(1).to({rotation:9.7102,x:489.95,y:925.25},0).wait(1).to({rotation:10.0406,x:526.65,y:914.05},0).wait(1).to({rotation:10.371,x:562.6,y:905.7},0).wait(1).to({rotation:10.7015,x:598.9,y:901.75},0).wait(1).to({rotation:11.0319,x:635.55,y:903.4},0).wait(1).to({rotation:11.3623,x:672.8,y:910.55},0).wait(1).to({rotation:11.6927,x:711.55,y:921.8},0).wait(1).to({rotation:12.0232,x:753.6,y:935.65},0).wait(1).to({rotation:12.3536,x:800.95,y:950.85},0).wait(1).to({rotation:12.684,x:855.05,y:964.6},0).wait(1).to({rotation:13.0144,x:918.1,y:987.1},0).wait(1).to({rotation:13.3449,x:984.8,y:1019.2},0).wait(1).to({rotation:13.6753,x:1024.7,y:1065.9},0).to({_off:true},1).wait(8));
	// Layer_4
	this.shape = new cjs.Shape();
	...
	this.instance_2.setTransform(644.9,1019.3);
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleX:0.8364,scaleY:0.7582,y:999.05},8,cjs.Ease.quadInOut).to({scaleX:1,scaleY:1,y:1019.3},18,cjs.Ease.quadInOut).wait(1));
	// Layer_2
	this.instance_3 = new lib.Symbol25("synched",0);
	this.instance_3.setTransform(647.7,718.7,5.0012,5.0012,0,0,0,0.2,0.3);
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:646.2,startPosition:8},8,cjs.Ease.quadInOut).to({y:718.7,startPosition:26},18,cjs.Ease.quadInOut).wait(1));
	// glasses
	this.instance_4 = new lib.Tween13("synched",0);
	this.instance_4.setTransform(644.1,683.2);
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({scaleX:0.9086,y:619.45},8,cjs.Ease.quadInOut).to({scaleX:1,y:683.2},18,cjs.Ease.quadInOut).wait(1));
	// face
	this.instance_5 = new lib.Tween16("synched",0);
	this.instance_5.setTransform(642.2,855.85);
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({scaleX:0.9527,scaleY:1.1008,y:803},8,cjs.Ease.quadInOut).to({scaleX:1,scaleY:1,y:855.85},18,cjs.Ease.quadInOut).wait(1));
	this._renderFirstFrame();
}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(84.4,-32.8,1115.6999999999998,1293.2);
// stage content:
(lib._100lick_lips = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(117.85,211.5,0.1825,0.1825,0,0,0,646.1,635);
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(27).to({mode:"single"},0).wait(58));
	this._renderFirstFrame();
}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(130.4,264.6,88.6,61);
// library properties:
lib.properties = {
	id: 'DC83E2275CE98A26111691300B8292EE',
	width: 230,
	height: 350,
	fps: 24,
	color: "#0066CC",
...
an.compositions['DC83E2275CE98A26111691300B8292EE'] = {
