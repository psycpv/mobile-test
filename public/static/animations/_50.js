...
(lib.tytyTween2 = function(mode,startPosition,loop,reversed) {
...
(lib.ththrb = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.thrtjhm = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.hhj = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.Twththeen4 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance = new lib.Symbol25("synched",5);
...
(lib.rth = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	cjs.MovieClip.apply(this,[props]);
	// crooked_hat
	this.instance = new lib.hhj("synched",0);
	this.instance.setTransform(28.5,-324.35,1,1,6.4746);
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleY:0.9535,rotation:2.7039,x:7.5,y:-350.45},7,cjs.Ease.get(1)).to({startPosition:0},6).to({scaleY:1,rotation:6.4746,x:28.5,y:-324.35},11,cjs.Ease.get(1)).wait(61));
	// Layer_20
	this.instance_1 = new lib.tytyTween2("synched",0);
	this.instance_1.setTransform(-110.55,-329.05);
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:-353.75},7,cjs.Ease.get(1)).to({startPosition:0},6).to({y:-329.05},11,cjs.Ease.get(1)).wait(61));
	// missing_tootth
	this.instance_2 = new lib.ththrb("synched",0);
	this.instance_2.setTransform(20.45,300.9);
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regY:0.1,scaleX:0.974,scaleY:1.1707,x:27,y:258.95},7,cjs.Ease.get(1)).to({startPosition:0},6).to({regY:0,scaleX:1,scaleY:1,x:20.45,y:300.9},11,cjs.Ease.get(1)).wait(61));
	// glasses_25
	this.instance_3 = new lib.Twththeen4("synched",0);
	this.instance_3.setTransform(30.1,21.05,1,1,9.4376,0,0,0.1,0.1);
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:0,regY:0,rotation:6.7254,x:36.35,y:-16.25},7,cjs.Ease.get(1)).to({startPosition:0},6).to({regX:0.1,regY:0.1,rotation:9.4376,x:30.1,y:21.05},11,cjs.Ease.get(1)).wait(61));
	// eyes1
	this.instance_4 = new lib.thrtjhm("synched",0);
	this.instance_4.setTransform(12.3,134.8);
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:0.1,scaleX:0.9613,scaleY:1.0363,x:12.4,y:94.45},7,cjs.Ease.get(1)).to({startPosition:0},6).to({regX:0,scaleX:1,scaleY:1,x:12.3,y:134.8},11,cjs.Ease.get(1)).wait(61));
	this._renderFirstFrame();
}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-541.1,-707,1115.7,1246.4);
// stage content:
...
if (reversed == null) { reversed = false; }
	...
	cjs.MovieClip.apply(this,[props]);
	// _50
	this.instance = new lib.rth("synched",0);
	this.instance.setTransform(121.8,227.7,0.182,0.182,0,0,0,39.9,-1.7);
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(85));
	this._renderFirstFrame();
}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(130.7,273.8,88.4,52.30000000000001);
// library properties:
lib.properties = {
	id: 'E5FEF38155D80AEC4DF970F550753399',
	width: 230,
	height: 350,
	fps: 24,
	color: "#0066CC",
...
an.compositions['E5FEF38155D80AEC4DF970F550753399'] = {
