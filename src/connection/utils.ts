...
export function getIsRabbyWallet(): boolean {
...
export function getConnectionName(
  ...
  hasRabbyExtension: boolean = getIsRabbyWallet()
) {
  switch (connectionType) {
    case ConnectionType.INJECTED: {
      if (hasMetaMaskExtension) return 'MetaMask'
      else if (hasRabbyExtension) return 'Rabby Wallet'
