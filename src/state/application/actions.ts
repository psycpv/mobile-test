...
export const setCjsLoaded = createAction<{ isLoaded: boolean }>('application/cjsLoaded')

export const showFlash = createAction<{ flashTime: number; flashType: 'increase' | 'decrease'; flashColor: string }>(
  'application/showFlash'
)

export const toggleSideBar = createAction('application/isSideBarVisible')
